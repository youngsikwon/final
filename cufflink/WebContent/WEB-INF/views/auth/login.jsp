					...
					<div class="column grid" style="border-right: 1px solid #dedede; vertical-align: middle;padding: 20px; width: 60%;">
						<form name="login">
							<div class="ui two column grid container">
								...
								<div class="column container" style="padding: 10px; padding-left:20px; width: 65%; text-align:left;">
								...
								<div class="column container" style="padding: 10px; width: 35%;"></div>
								<div class="column container" style="padding: 10px; padding-top: 20px; width: 65%; text-align:right;">
									<label>비밀번호를 잊으셨나요? <a href="/idpassfind">비밀번호 찾기</a></label>
								</div>
							</div>
						</form>
					</div>

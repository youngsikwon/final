...
<!----------------------------------------------------------------------- main content 시작 -->
	...
	<!-- main 입력 시작-->
		...
		<div class="ui two column grid container" style="height: 1260px">
			...
			<div class="ui column" style="padding-left: 5px; padding-top: 0px; padding-bottom: 0px; padding-right: 10px; width: 80%;">
				...
				<div class="ui container" style="padding-left: 20px; padding-top: 20px; padding-bottom: 0px; left: 5px; border: 1px solid #dedede; height:1130px;">
					<div class="ui two column grid container">

...
<!----------------------------------------------------------------------- top 시작 -->
	...
	<!-- navigation menu 시작 -->
			<div class="ui navigation">	
				<jsp:include page="../../common/menu/navigationPartnersMenu.jsp"/>
			</div>
	<!-- navigation menu 종료-->
		</div>
	</header>
...
<!-- 서브 메뉴 ===================================================================================-->
			...
			<div class="thirteen wide column ui segment"style="padding-top: 10px;">
			 	
				<% 
					String path = (String)request.getAttribute("path");
					if(path.equals("partnersMyprofileMain")){ %>
				     <jsp:include page="./partnersShowAll.jsp" />
				     
				  <%}	
					else if(path.equals("partnersIntroduction")){%>
					<jsp:include page="./partnersIntroduction.jsp" />
					<script>$(document).ready(function(){
				    	 $('footer').css('position','absolute')
				     })</script>
		          <%}	
					else if(path.equals("partnersPortfolio")){%>
				  ...
				  <%}
					else if(path.equals("partnersSkill")){%>
				  	<jsp:include page="./partnersSkill.jsp"/>
				  	<script>$(document).ready(function(){
				    	 $('footer').css('position','absolute')
				     })</script>
				  <%}
					else if(path.equals("partnersBackground")){%>
					<jsp:include page="./partnersBackground.jsp"/>
					<script>$(document).ready(function(){
				    	 $('footer').css('position','absolute')
				     })</script>
				  <%} 
				  	else if(path.equals("partnersEvaluation")){%>

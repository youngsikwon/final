...
<html>
<head>
<jsp:include page="../views/common/ui.jsp"/>
<meta charset="UTF-8">
...
<!----------------------------------------------------------------------- top 시작 -->
	...
	<!-- header 시작 -->
			<div class="ui">
				<jsp:include page="../views/common/menu/headerMenu.jsp"/>
			</div>
	<!-- header 종료 -->
	...
	<!-- navigation menu 시작 -->
			<div class="ui navigation">
				<jsp:include page="../views/common/menu/navigationMenu.jsp"/>
			</div>
	<!-- navigation menu 종료-->
		</div>
	</header>
	...
	<!-- footer 시작-->
		<footer class="footer">
			<div class="ui inverted segment">
					<jsp:include page="../views/common/menu/footerMenu.jsp"/>
			</div>
		</footer>
	<!-- footer 끝-->
<!----------------------------------------------------------------------- footer content 끝 -->

			...
			<div class="content-middle">
				<div class="ui two column grid container"
					...
					<div class="column grid"
						style="border-right: 1px solid #dedede; vertical-align: middle; padding: 20px; width: 60%;">
						<div class="ui two column grid container">
							<div class="center column container"
								style="padding: 17px; width: 35%;">
								<span>*</span>아이디 또는 이메일
							</div>
							<div class="column container" style="padding: 10px; width: 65%;">
								<form id="f_login">
									<div class="ui left icon input">
										<input name="f_id" type="text" placeholder="아이디 또는 이메일"
							...
							<div class="column container" style="padding: 10px; width: 65%;">
								<div class="ui checkbox">
									<input type="checkbox" name="example" /> <label>로그인 상태
										유지</label>
								</div>
							</div>
							<div class="column container" style="padding: 10px; width: 35%;"></div>
							<div class="column container"
								style="padding: 20px; width: 65%; text-align: center;">
								<div class="ui two column grid container">
									<div class="cloumn container" style="width: 50%;">
										<div class="ui fluid animated fade button" tabindex="0">
											...
											<div class="hidden content" onClick='login()'>Login
												Click</div>
										</div>
									</div>
							...
							<div class="column container" style="padding: 10px; width: 35%;"></div>
							<div class="column container" style="padding: 10px; width: 65%;">
								<label>비밀번호를 잊으셨나요? <a href="/idpassfind">아이디 비밀번호
										찾기</a></label>
							</div>
						</div>
					</div>

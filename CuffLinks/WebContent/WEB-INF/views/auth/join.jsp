						...
						<form id="f_join" name="join">
							<div class="ui three column grid container ">
								...
								<div class="ui left icon input" style="padding: 10px; width: 50%">
									<input id="j_email" name="j_email" type="text" placeholder="이메일" size="40px">
								...
								<div class="ui left icon input" style="padding: 10px; width: 50%">
									<input id="j_email_check" name="j_email_check" type="text" placeholder="이메일인증" size="40px">
									<i class="id envelope icon"></i>
								</div>
								...
								<div id="a_email_check" class="center-right" style="padding-top: 10px; margin-left: 0; width: 20%; height: 17px; margin: 0px; padding-left: 0;">
									<div id="b_email" class="ui animated fade button" tabindex="0" onClick="b_email()" style="margin-left: 0;">
								...
								<div class="ui left icon input" style="padding: 10px; width: 50%;">
									<input id="j_id" name="j_id" type="text" placeholder="아이디" size="40px">
								...
								<div class="ui left icon input" style="padding: 10px; width: 50%;">
									<input id="j_pw" name="j_pw" type="text" placeholder="비밀번호" size="40px">
									<i class="key icon"></i>
								</div>
								...
								<div class="ui left icon input" style="padding: 10px; width: 50%;">
									<input id="j_pw2" name="j_pw2" type="text" placeholder="비밀번호" size="40px">
									<i class="key icon"></i>
								</div>

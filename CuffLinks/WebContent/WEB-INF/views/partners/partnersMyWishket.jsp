         ...
         <div class="ui column" style="padding-left: 0px; padding-top: 0px; padding-bottom: 0px; width: 80%;">
            <div class="ui segment container" style="padding: 20px; padding-bottom: 20px; left: 0px; border: 1px solid #dedede;">
               <div style="padding-bottom:0px;">
                  <h3 style="text-align: left">마이 위시캣</h3>
               </div>
            </div>
<!-- 상단 +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->
            <div class="ui segment container" style="padding: 20px; padding-bottom: 20px; left: 0px; border: 1px solid #dedede;">
...
<!-- 중간 +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->
            <div class="ui segment container" style="padding: 20px;margin-bottom:50px;padding-bottom: 20px; left: 0px; border: 1px solid #dedede;">
               <div class="ui three column grid container">
                  <div class="column" style="padding-bottom:20px; width:50%;">
               ...
               <div class="ui" style="padding-left: 20px; padding-right: 20px; padding-top: 0px; padding-bottom: 20px;text-align:left;">
                     <div class="ui column segment" style="padding-top:30px;">
                        <div class="ui blue top left attached label"><a href="../manage/partnersInterestProject">>>관심 중<<</a></div>
                        <div class="ui three column grid container" style="padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px;text-align:center;" >
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td><a href=""><%=interest.get(i).get("PRO_NAME") %></a></td>
                              <td><%=interest.get(i).get("PRO_PRICE") %></td>
                              <td><%=interest.get(i).get("PRO_PERIOD") %></td>
                              <td><%=interest.get(i).get("PRO_END") %>  </td>
                            </tr>
                            <%} %>
                          </tbody>
                        </table>
               ...
               <div class="ui" style="padding-left: 20px; padding-right: 20px; padding-top: 0px; padding-bottom: 20px;text-align:left;">
                     <div class="ui column segment" style="padding-top:30px;">
                        <div class="ui orange top left attached label"><a href="../manage/partnersSupportHistory">>>지원 중<<</a></div>
                        <div class="ui four column grid container" style="padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px;text-align:center;" >
                          ...
                          <%for(int i=0;i<support.size();i++){ %>
                            <tr>
                              <td><a href=""><%=support.get(i).get("PRO_NAME") %>  </a></td>
                              <td><%=support.get(i).get("PRO_PRICE") %> </td>
                              <td><%=support.get(i).get("PRO_PERIOD") %></td>
                              <td><%=support.get(i).get("PRO_END") %>   </td>
                            </tr>
                           <%} %>
                          </tbody>
                        </table>
               ...
               <div class="ui" style="padding-left: 20px; padding-right: 20px; padding-top: 0px; padding-bottom: 0px;text-align:left;">
                     <div class="ui column segment" style="padding-top:30px;">
                        <div class="ui green top left attached label"><a href="../manage/partnersProject_ing">>>프로젝트 진행 중<<</a></div>
                        <div class="ui six column grid container" style="padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px;text-align:center;" >
                          ...
                          <%for(int i=0;i<ing.size();i++){ %>
                            <tr>
                              <td><a href=""><%=ing.get(i).get("PRO_NAME") %></a></td>
                              <td><%=ing.get(i).get("PRO_PRICE") %></td>
                              <td><%=ing.get(i).get("PRO_PERIOD") %></td>
                              <td><%=ing.get(i).get("PRO_END") %></td>
                            </tr>
                            <%} %>
                          </tbody>
                        </table>

			...
			<div class="content-middle-join">
				<div class="ui two column grid container" style="padding: 0px;">
					<div class="column grid"
						style="border-right: 1px solid #dedede; vertical-align: middle; padding: 20px; width: 70%;">
						<div class="ui two column grid container">
							...
							<div class="column container"
								style="padding-left: 10px; padding-top: 0px; padding-bottom: 0px; width: 75%;">
								<hr class="garo" />
							</div>
							<div class="center column container"
								style="padding: 17px; width: 25%;">
							...
							<div class="column container" style="padding: 10px; width: 75%;">
								<div class="ui input">
									<select name="skills" class="ui search dropdown">
										...
										style="padding: 5px; color: gray;"></i><input type="text"
										size="5px"><i class="window minimize outline icon"
										style="padding: 5px; color: gray;"></i><input type="text"
										size="5px">
								</div>
							</div>
							...
							<div class="column container"
								style="padding-top: 0px; width: 75%;">
								<div class="ui comments">
									<form class="ui reply form">
										<div class="field">
											<textarea
												style="margin-top: 0px; margin-bottom: 0px; height: 170px;"></textarea>
										</div>
										<p>회사(개인)에 대해 간략하게 설명해주세요(150자 이내)</p>
										<div id="ProjectRegisterButton"

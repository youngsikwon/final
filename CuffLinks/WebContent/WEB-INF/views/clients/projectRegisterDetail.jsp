					...
					<div class="ui two column grid container" style="padding: 0px;">
	                   ...
	                   <!--            <input id="pro_file" name="pro_file" type="file" class="inputfile" /> -->
								...
								<div class="column container"
									...
									<input type="radio" name="pro_management" class="r1" value = "있음" />&nbsp;&nbsp;예,
									매니징 경험이 있습니다.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input
										type="radio" name="pro_management" class="r2"value = "없다" />&nbsp;&nbsp; 아니오,
									없습니다.
								</div>
								...
								<div class="column container"
									style="padding: 10px; padding-bottom: 5px; padding-top: 20px; width: 75%; text-align: left;">
									<input type="radio" name="pro_partners" class="r3" value = "상관없음." />&nbsp;&nbsp;상관
									없음.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio"
										name="pro_partners" class="r4" value = "범인사업자."/>&nbsp;&nbsp;법인
									사업자&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; <input type="radio"
										name="pro_partners" class="r4" value = "개인사업자"/>&nbsp;&nbsp;개인
									사업자.&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; <input type="radio"
										name="pro_partners" class="r4" value = "개인"/>&nbsp;&nbsp;팀&nbsp;&nbsp;&nbsp;

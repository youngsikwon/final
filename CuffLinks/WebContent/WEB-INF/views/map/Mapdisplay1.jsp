...
<!-- 	<div class="ui search">
	...
	<div id="namverMap">
		...
		<div id="pano" style="width: 600px; height: 480px;"></div>
	</div>
...
<script>
	...
	function initPanorama(y, x) {
		...
		var contentString = [ '<div class="ui segment" style="width: 270px;height: 190px;padding-top: 0px;padding-left: 0px;padding-bottom: 0px;padding-right: 0px;margin-bottom: 0px;">'
							...
							function(result, status) {
								...
								if (status === daum.maps.services.Status.OK) {
									...
									var iwContent = '<div class="ui segment" style="width: 270px;height: 190px;padding-top: 0px;padding-left: 0px;padding-bottom: 0px;padding-right: 0px;margin-bottom: 0px;">'
											...
											+ obj[a].PRO_ADDR
											+ '<br></br>'
											+ obj[a].C_BUSINESSNUMBER
											+ '<br></br></div></div></div><div class="ui buttons" style = "margin-top:10px;">'
											+ '<button onClick = "road()" class="ui button" style="margin-left: 55px;">길찾기</button><div class="or"></div><button onClick = "roadView('
											+ y
											+ ','
											+ x
												...
												.getCurrentPosition(
														function(position) {
															coords = new daum.maps.LatLng(
																	position.coords.latitude + 0.006,
																	position.coords.longitude + 0.00004);

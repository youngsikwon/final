			...
			<div class="ui column"
				...
				<div class="ui fluid vertical menu" style="padding-right: 0px">
					<a href="/ProjectRecruiting" class="teal item active">
						<font style="vertical-align: inherit;"> 지원자 모집중 </font>
					</a>
				</div>
			</div>
			<div class="ui column"
				...
				<div
					...
					<div class="ui two column grid container"
						...
						<div class="column"
							...
							1. 지원자 모집 중인 프로젝트 목록입니다.<br> 2. [지원자 목록] 버튼을 클릭하여 지원자들의 지원
							내역을 확인할 수 있습니다.<br> 3. 미팅을 신청하면 스케줄 매니저가 미팅 조율을 도와드립니다.<br>
							4. 지원자 모집에 대한 문의는 고객센터로 연락 부탁드립니다.<br> 고객센터: (02) 0000-0000
							/ help@cufflink.com
						</div>
					</div>
					...
					<div class="ui column segment"
						...
						<div class="sub header">
							...
							예상금액 원 | <%=state.get("PRO_PRICE") %>
							<i class="clock outline icon"></i>
							예상기간 일 <%=state.get("PRO_PERIOD") %>
						</div>
						<p style="margin-bottom: 30px;"></p>
						<div class="sub header">
							cate_main  <%=state.get("CATE_MAIN") %>
							<i class="angle right icon"></i>
							cate_sub <%=state.get("CATE_SUB") %> | 위치
							<i class="angle right icon"></i>
						</div>

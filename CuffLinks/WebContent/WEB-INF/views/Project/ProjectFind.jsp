					...
					<div class="column" style="text-align: right; margin: 10px 0px;">
						...
						<div class="ui search">
							<div class="ui icon input">
								<input class="prompt" type="text" placeholder="Search countries..."> <i class="search icon"></i>
							</div>
			...
			<div class="content-middle-project">
				<div class="ui two column grid container" style="padding: 00px; overflow: hidden;">
								...
								<div class="ui relaxed list " style="padding-top: 0px; padding-bottom: 10px; padding-left: 5px; padding-right: 5px;">
									<div class="item" style="text-align: left; padding-top: 0px; padding-bottom: 10px; padding-left: 0px; padding-right: 5px;">
										...
										<form name="develope" id='devs'>
											<div class="ui master checkbox" STYLE=" font-size: 12px">
											...
											<div class="list">
												...
												<div class="item dev">
													<div class="ui child checkbox" STYLE=" font-size: 12px">
										...
										<form name="design" id='designs'>
											...
											<div class="list">
												...
												<div class="item design">
													<div class="ui child checkbox" STYLE=" font-size: 12px">
														<input type="checkbox" name="design_List" value='<%=sub2.get("CATE_SUB")%>'> <label class="h11"><%=sub2.get("CATE_SUB")%></label>
													</div>
												</div>
												<%
													}
					...
					<div class="column grid" style="padding-top: 0px; padding-bottom: 0px; padding-left: 10px; padding-right: 0px; width: 85%;">
						...
						<div >
						<!-- db 공통 코드===================================================================================================================================== -->
							<div class="ui raised segment" style="padding: 20px;background-color: #dedede;">
								<div class="column" style="text-align: left;">
								...
								<div class="ui two column grid container" style="padding: 0px; height: 100px;">
									<div class="column grid" style="padding-top: 10px; padding-bottom: 10px; padding-left: 10px; padding-right: 5px; width: 80%; border-right: 1px solid grey; text-align: left"><%=Project.get("PRO_CONTENTS")%></div>

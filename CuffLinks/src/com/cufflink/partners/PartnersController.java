...
public class PartnersController {
	...
	public String partnersMyprofileMain(Model mod, @RequestParam Map<String,Object> pno) {
	...
	//파트너스 마이 위시캣 - 파트너스로 로그인 성공시 바로나오는 페이지@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
//	@RequestMapping("/partnersMyWishket/{s_email}")
	@RequestMapping("/partnersMyWishket")
	//public String partnersMyWishket(Model mod, @PathVariable String s_email, @RequestParam int pno, HttpSession session, HttpServletRequest req) {
//	public String partnersMyWishket(Model mod, @PathVariable String s_email ,HttpSession session, HttpServletRequest req) {
	public String partnersMyWishket(Model mod, @RequestParam Map<String,Object> pMap, HttpSession session, HttpServletRequest req) {
...
//	public String partnersList(Model mod, @PathVariable String id,@RequestParam int pno , HttpSession session, HttpServletRequest req) {
	...
	public String partnersInterestProject(Model mod, @RequestParam Map<String,Object>pMap, HttpSession session, HttpServletRequest req) {
	...
	public String partnersSupportHistory(Model mod, @RequestParam Map<String,Object>pMap, HttpSession session, HttpServletRequest req) {
	...
	public String partnersProject_ing(Model mod,  @RequestParam Map<String,Object>pMap, HttpSession session, HttpServletRequest req) {
	...
	public String partnersCompleteProject(Model mod, @RequestParam Map<String,Object>pMap, HttpSession session, HttpServletRequest req) {

					...
					<div class="column grid" style="padding: 10px; width: 80%;">
						...
						<form id="f_join" name="join">
							<div class="ui three column grid container ">
								...
								<div class="ui left icon input" style="padding: 10px; width: 50%;">
									<input id="j_pw" name="j_pw" type="text" placeholder="비밀번호" size="40px"> <i class="key icon"></i>
								</div>
								...
								<div class="ui left icon input" style="padding: 10px; width: 50%;">
									<input id="j_pw2" name="j_pw2" type="text" placeholder="비밀번호" size="40px"> <i class="key icon"></i>
								</div>

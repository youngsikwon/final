				...
				<div class="ui container" style="padding-left: 20px; padding-right: 20px; padding-top: 30px; padding-bottom: 20px; left: 5px; border: 1px solid #dedede; min-height:480px; height: auto; background-color: #E6E6E6;">
					...
					<div style="padding-top: 0px;">
						<div class="ui two column grid container">
							...
							<div class="column container" style="padding: 10px; width: 60%;">
								<select id='emailList' name="skills" class="ui fluid search dropdown" style="width: 73%;">
									<!-- 프로젝트 목록 표시 -->
							...
							<div class="column container" style="padding: 10px; width: 60%;">
								<div class="ui input">
									<input id="coin" type="text" placeholder="입금코인을 입력하세요." size="45px">
								</div>
								<div class="ui">
							...
							<div class="ui container" style="padding-right: 30px; text-align: right;">
								<button id='insertCoin' class="ui blue button" onclick="insertCoin()">입금완료</button>
							</div>
							<p></p>
						</div>
						<div class="ui container">

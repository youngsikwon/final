...
<body>
	...
	<script type="text/javascript">
		$(document).ready(
				function() {
					...
					$("#ProjectRegisterDetailButton").click(
							function() {
								...
								if ($("#pro_name").val() == "") {
									...
									$("#ClientProjectRegiste").attr("action",
											"/client/projectRegister");
	...
	<div class="ui container raised segment content">
		...
		<div class="ui container">
			<div class="content-middle-join" style=" background-color: #E6E6E6;">
				<form id="ClientProjectRegiste" method="post" enctype="multipart/form-data">
					<div class="ui two column grid container" style="padding: 0px;">
						...
						<div class="segment column grid" style="border-right: 0px solid #dedede; vertical-align: middle; padding: 20px; width: 100%;">
							<div class="ui two column grid container">
								...
								<div class="column container" style="padding: 10px; padding-bottom: 5px; width: 75%;">
									<div style="width: 25%; float: left;">
										<select id="pro_skill" name="pro_skill" class="ui fluid search dropdown">
											<option value="개발">개발</option>
											<option value="디자인">디자인</option>
										</select>
									</div>
									<div style="width: 50%; float: left; margin-left: 20px;">
										<select id="pro_partners" name="pro_partners" class="ui fluid search dropdown">
										...
										</select> <select id="pro_partners2" name="pro_partners2" class="ui fluid search dropdown">
								...
								<div class="column container" style="padding: 10px; padding-bottom: 5px; width: 75%; text-align: left;">
									<div class="ui input">
										<input id="pro_name" name="pro_name" type="text" placeholder="프로젝트 제목을 입력하세요." size="60px">
									</div>
								</div>
								<div class="column container" style="padding-left: 10px; padding-top: 0px; padding-bottom: 0px; width: 25%;"></div>
								<div class="column container" style="padding-left: 10px; padding-top: 0px; padding-bottom: 5px; width: 75%; text-align: left;">
								...
								<div class="column container" style="padding: 10px; padding-bottom: 0px; width: 75%; text-align: left;">
									<div class="ui input" style="float: left;">
										<input id="pro_period" name="pro_period" type="text" size="20px">
									</div>
									<div style="width: 40px; height: 38px; border: 1px solid #dedede; float: left; padding: 9px; background-color: #dedede;">일</div>
								</div>
								<div class="column container" style="padding-left: 10px; padding-top: 0px; padding-bottom: 0px; width: 25%;"></div>
								<div class="column container" style="padding-left: 10px; padding-top: 0px; padding-bottom: 5px; width: 75%; text-align: left;">
								...
								<div class="column container" style="padding: 10px; padding-bottom: 0px; width: 75%; text-align: left;">
									...
									<div style="width: 40px; height: 38px; border: 1px solid #dedede; float: left; padding: 9px; background-color: #dedede;">원</div>
								</div>
								<div class="column container" style="padding-left: 10px; padding-top: 0px; padding-bottom: 0px; width: 25%;"></div>
								<div class="column container" style="padding-left: 10px; padding-top: 0px; padding-bottom: 5px; width: 75%; text-align: left;">
									<p>
									...
									<div class="column container" style="padding: 10px;">
										<div class="ui two column grid container" style="padding: 10px; padding-left: 0; text-align: center;">
											<div class="column container" style="margin-right: 5px; padding: 10px; width: 32%; margin-left: 0px; text-align: center; vertical-align: middle; outline: dotted gray 0.5px;">
												...
												<div>
													<input type="radio" id="pro_plan" name="pro_plan" checked="checked" value="아이디어만 있습니다.">
												</div>
												<div>
													<p>아이디어만 있습니다.</p>
												</div>
											...
											<div class="column container" style="margin-right: 5px; padding: 10px; width: 32%; text-align: center; vertical-align: middle; outline: dotted gray 0.5px;">
												...
												<div>
													<input type="radio" id="pro_plan" name="pro_plan" checked="checked" value="필요한 내용들을 간단히 정리해두었습니다.">
												</div>
												<div>
											...
											<div class="column container" style="padding: 10px; width: 32%; text-align: center; vertical-align: middle; outline: dotted gray 0.5px;">
												...
												<div>
													<input type="radio" name="pro_plan" checked="checked" value="상세한 기획 문서가 존재합니다.">
												</div>
												<div>
													<p>
														상세한 기획 문서가 <br>존재합니다.
								...
								<div class="column container" style="padding-top: 0px; width: 75%; padding-left: 10px;">
									<div class="ui comments">
										<div class="field">
											<textarea id="pro_contents" name="pro_contents" style="margin-top: 0px; margin-bottom: 0px; width: 100%; height: 170px;"></textarea>
										</div>
									</div>
								</div>
								...
								<div class="column container" style="padding: 10px; padding-bottom: 5px; width: 75%; text-align: left;">
									<div class="ui action input">
										<input type="text" placeholder="파일첨부창" readonly> <input id="pro_file" name="pro_file" type="file">
								...
								<div class="column container" style="padding-left: 10px; padding-top: 0px; padding-bottom: 5px; width: 75%; text-align: left;">
									<p>
										첨부 파일은 파트너들에게 공개되지 않습니다.<br> 첨부 파일은 프로젝트 금액 및 기간 산정을 위한 검수 자료로만 사용됩니다.
									</p>
								</div>
								...
								<div class="column container" style="padding: 10px; padding-bottom: 5px; width: 75%; text-align: left;">
									<div class="ui input">
										<select name="pro_end" id="pro_end" class="ui fluid search dropdown">
								...
								<div class="column container" style="padding: 10px; padding-bottom: 5px; width: 75%; text-align: left;">
									<div class="ui input">
										<select name="pro_start" id="pro_start" class="ui fluid search dropdown">
								...
								<div class="column container" style="padding: 10px; padding-bottom: 5px; padding-top: 20px; width: 75%; text-align: left;">
									<input type="radio" name="pro_management" class="r1" value="있음" checked="checked" />&nbsp;&nbsp;예, 매니징 경험이 있습니다.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" name="pro_management" class="r2" value="없다" checked="checked" />&nbsp;&nbsp; 아니오, 없습니다.
								</div>
								...
								<div class="column container" style="padding: 10px; padding-bottom: 5px; padding-top: 20px; width: 75%; text-align: left;">
									<input type="radio" name="pro_partner" class="r3" value="상관없음." checked="checked" />&nbsp;&nbsp;상관 없음.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" name="pro_partner" class="r4" value="범인사업자." checked="checked" />&nbsp;&nbsp;법인 사업자&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; <input type="radio" name="pro_partner" class="r4" value="개인사업자" checked="checked" />&nbsp;&nbsp;개인 사업자.&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; <input type="radio" name="pro_partner" class="r4" value="개인" checked="checked" />&nbsp;&nbsp;팀&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; <input type="radio" name="pro_partner" class="r4" checked="checked" />&nbsp;&nbsp;개인
								</div>
								<div class="column container" style="padding-left: 10px; padding-top: 0px; padding-bottom: 0px; width: 25%;"></div>

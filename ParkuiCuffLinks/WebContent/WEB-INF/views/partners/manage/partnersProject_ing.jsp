		...
		<div class="ui two column grid container" style="height: auto; margin-bottom: 10px;">
			<div class="ui column" style="width: 20%; padding-top: 0px; padding-left: 0px; padding-right: 0px">
				...
				<div class="ui fluid vertical menu" style="padding-top: 10px; padding-bottom: 10px; padding-left: 15px; padding-right: 15px; background-color: #E0F8E6">
					...
					<b><font style="vertical-align: inherit;">커프링크 대금보호계좌 정보</font></b> <br> <br>
					<h11>은행명 : 기업은행<br>
					예금주 : (주)커프링크<br>
			...
			<div class="ui column" style="padding-left: 5px; padding-top: 0px; padding-bottom: 0px; width: 80%; height: auto;">
				...
				<div class="ui two column grid container" style="padding-top: 0px; border: 1px solid #dedede; margin-bottom: 5px;">
					...
					<div class="column" style="width: 90%; text-align: left; padding-left: 5px">
						1. 현재 진행 중인 프로젝트 목록입니다.<br> 2. 프로젝트는 <strong>대금 결제 후</strong>에 진행됩니다.<br> 3. 커프링크은<strong> <대금보호시스템></strong>을 통해 프로젝트가 완료될 때까지 대금을 안전하게 보호합니다.<br> 4. 프로젝트 진행에 대한 문의는 <strong>고객센터</strong>로 연락 부탁드립니다.<br> &nbsp; 고객센터: (02) 0000-0000 / help@cufflink.com
					</div>
				</div>
				<div style="padding-top: 20px; padding-bottom: 0px; padding-left: 15px; padding-right: 15px; border: 1px solid #dedede; background-color: #dedede;">
					...
					%>
					<div style="text-align: left; padding-left: 10px; padding-top: 20px; padding-bottom: 0px">프로젝트 진행 내역이 없습니다.</div>
					<%
						}
					%>
					<%
					...
					<div class="ui" style="position: relative; margin-bottom: 20px; padding-left: px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px; text-align: left;">
						<div class="ui column segment" style="padding-top: 10px;" align="left">
							<!-- *********************************************************************************************************************************************20181013 수정요청사항 -->
							<div class="ui green top left attached label" style="position: absolute; top: -10px; left: -10px;">진행중</div>

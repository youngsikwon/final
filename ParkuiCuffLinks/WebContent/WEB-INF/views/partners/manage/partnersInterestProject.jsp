...
<body>
	...
	<div class="ui container">
		...
		<div class="ui two column grid container"
			style="height: auto; margin-bottom: 50px;">
			<div class="ui column"
			...
			<div class="ui column"
				style="padding-left: 5px; padding-top: 0px; padding-bottom: 0px; width: 80%; height: auto">
				<div class="ui container"
				...
				<div
					...
					<div style="height: 10px;"></div>
					<div class="ui two column grid container"
						style="padding-top: 0px; border: 1px solid #dedede; margin-bottom: 30px;">
						...
						<div class="column"
							...
							<br>
							3. 프로젝트 모집이 마갑된 경우, 목록에서 자동으로 삭제됩니다.
							<br>
							4.
							<strong>[프로젝트 지원하기]</strong>
							버튼을 클릭하여 해당 프로젝트에 지원할 수 있습니다.
						</div>
					</div>
					<%
					...
					<form id="f_attention" action="/partners/projectAttention" method="get">
						<input type="hidden" name="s_email"
							value="${email}">
						<input type="hidden" name="pro_no" value=<%=list.get(i).get("PRO_NO") %>>
						<input type="hidden" name="su_money"
							value=<%=list.get(i).get("PRO_PRICE")%>>
						<input type="hidden" name="su_state" value="관심">
					</form>
					<div class="ui ten wide column segment"
						style="padding-top: 15px; padding-left: 30px; text-align: left !important;">
						...
						<div class="sub header">
							...
							예상금액&nbsp;&nbsp;<%=list.get(i).get("PRO_PRICE")%>
							&nbsp;원 &nbsp; &nbsp; | &nbsp; &nbsp;
							<i class="clock outline icon"></i>
							예상기간&nbsp;<%=list.get(i).get("PRO_PERIOD")%>
						</div>
						...
						<div class="sub header" style="margin-bottom: 10px;">
							...
							&nbsp;&nbsp;|&nbsp; &nbsp; 위치
							<i class="angle right icon"></i><%=list.get(i).get("PRO_ADDR")%>
						</div>
						<div class="four wide column "
							style="padding: 10px; padding-left: 30px;"></div>
